...
namespace AppConstants {
  ...
  constexpr uint8_t PIN_DIGI_LIGHT_MODE_1_LED = A3; // outer
  constexpr uint8_t PIN_DIGI_LIGHT_MODE_2_LED = A4; // inner
  constexpr uint8_t PIN_DIGI_LIGHT_MODE_3_LED = A5; // ramp
  constexpr uint8_t PIN_CALIBRATION_BUTTON = 2;
  constexpr uint8_t PIN_DIGI_MOTOR_BACKWARD = A6;
  constexpr uint8_t PIN_DIGI_OUTER_BRAKE_LED = A1;
  constexpr uint8_t PIN_DIGI_OUTER_BRAKE_MODE = A0;
